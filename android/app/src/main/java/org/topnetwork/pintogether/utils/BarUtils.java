...
public class BarUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = NormalBaseConfig.getContext().getResources();
    ...
    public static View setStatusBarColor1(@NonNull final Activity activity,
                                          @ColorInt final int color) {
        ...
        return applyStatusBarColor(activity, color, false);
    }
    ...
    public static int getActionBarHeight() {
        ...
        if (NormalBaseConfig.getContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, NormalBaseConfig.getContext().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = NormalBaseConfig.getContext().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = NormalBaseConfig.getContext().getResources();
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = NormalBaseConfig.getContext()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) NormalBaseConfig.getContext().getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(NormalBaseConfig.getContext()).hasPermanentMenuKey();
