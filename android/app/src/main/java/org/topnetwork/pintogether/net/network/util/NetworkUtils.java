package org.topnetwork.pintogether.net.network.util;
...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        NormalBaseConfig.getContext().startActivity(
    ...
    public static boolean isAvailableByDns(final String domain) {
        final String realDomain = TextUtils.isEmpty(domain) ? "http://www.baidu.com" : domain;
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) NormalBaseConfig.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) NormalBaseConfig.getContext().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) NormalBaseConfig.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) NormalBaseConfig.getContext().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
