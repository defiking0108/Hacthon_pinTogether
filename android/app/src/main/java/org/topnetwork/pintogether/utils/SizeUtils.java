...
public final class SizeUtils {
    ...
    public static int getScreenWidth(){
        return NormalBaseConfig.getContext().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight(){
        return NormalBaseConfig.getContext().getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static int dp2px(final float dpValue) {
        final float scale = NormalBaseConfig.getContext().getResources().getDisplayMetrics().density;
