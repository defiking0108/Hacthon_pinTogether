...
package org.topnetwork.pintogether.utils.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    private void drawTextInfo(Canvas canvas, Rect frame) {
        ...
        if (iDrawTextInfoAfter != null) {
            iDrawTextInfoAfter.drawTextInfo(frame.left + frame.width() / 2, frame.bottom);
        }
    }
...
//      canvas.drawRect(frame.left, scannerStart, frame.right, scannerStart + SCANNER_LINE_HEIGHT, paint);
    ...
    private IDrawTextInfoAfter iDrawTextInfoAfter;

    public IDrawTextInfoAfter getDrawTextInfoAfter() {
        return iDrawTextInfoAfter;
    }

    public void setDrawTextInfoAfter(IDrawTextInfoAfter iDrawTextInfoAfter) {
        this.iDrawTextInfoAfter = iDrawTextInfoAfter;
    }

    public interface IDrawTextInfoAfter {
        void drawTextInfo(int x, int y);
    }
