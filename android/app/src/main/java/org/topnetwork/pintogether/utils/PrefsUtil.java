...
public class PrefsUtil {
     ...
     * 保存在手机里面的文件名
     */
    private static final String FILE_NAME = "pin_together_shared_preference";
    ...
    public static void put(String key, Object object) {
        ...
        put(NormalBaseConfig.getContext(), key, object);
    }
    ...
    public static Object get(String key, Object defaultObject) {
        return get(NormalBaseConfig.getContext(), key, defaultObject);
    }
    ...
    public static void clear() {
        clear(NormalBaseConfig.getContext(), FILE_NAME);
    }
