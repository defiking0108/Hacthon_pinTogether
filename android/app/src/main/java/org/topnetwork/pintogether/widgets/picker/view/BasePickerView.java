...
import org.topnetwork.pintogether.widgets.picker.listener.OnDismissListener;
import org.topnetwork.pintogether.widgets.picker.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            if(mPickerOptions.isShowBg){
                dialogView = (ViewGroup) layoutInflater.inflate(R.layout.layout_basepickerview, null, false);
            }else {
                dialogView = (ViewGroup) layoutInflater.inflate(R.layout.layout_basepickerview1, null, false);
            }
            //设置界面的背景为透明
